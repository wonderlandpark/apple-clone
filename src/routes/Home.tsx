...
export default function Home () {
  return (
      <div style={{ position: 'absolute', width: '100%', height: '100%' }}>
        <video autoPlay muted loop style={{ position: 'absolute', minWidth: '100%', minHeight: '100%', objectFit: 'cover', width: 'auto', height: 'auto' }} id="airpodsMax" src="/airpods-max.mp4" playsInline>
        </video>
